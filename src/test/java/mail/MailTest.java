...
//		message.setFrom(new InternetAddress("liufeiyu6@163.com"));
		...
		message.setText("this is lyc test mail3 fpbox to dingxueyin second");
...
//		tran.connect("smtp.163.com",25,"liufeiyu6@163.com","lzc19910416");
		...
		tran.sendMessage(message, new InternetAddress[]{new InternetAddress("liuyingchao@ele-cloud.com")});
		tran.close();
	}
}
